...
private:
  ...
  uint64_t removePiece(uint64_t piecePositions, int index, PieceColor color);
  uint64_t removePiece(uint64_t piecePositions, sf::Vector2i boardPos,
                       PieceColor color);

  // if adding a piece, there must not be anything there currently
  uint64_t addPiece(uint64_t piecePositions, int index, PieceColor color);
  uint64_t addPiece(uint64_t piecePositions, sf::Vector2i boardPos,
                    PieceColor color);

  void highlightUserPosition(int index);

  void drawPiece(uint64_t piecePositions, sf::Texture &pieceTexture);

  // move generation
  bool hasCollided(int index, PieceColor color, bool &addPiece) const;
...
private:
  ...
  sf::Texture whitePawnTexture =
      loadTextureFromFile("../resources/whitePawn.png");
  sf::Texture whiteRookTexture =
      loadTextureFromFile("../resources/whiteRook.png");
  sf::Texture whiteKnightTexture =
      loadTextureFromFile("../resources/whiteKnight.png");
  sf::Texture whiteBishopTexture =
      loadTextureFromFile("../resources/whiteBishop.png");
  sf::Texture whiteQueenTexture =
      loadTextureFromFile("../resources/whiteQueen.png");
  sf::Texture whiteKingTexture =
      loadTextureFromFile("../resources/whiteKing.png");

  sf::Texture blackPawnTexture =
      loadTextureFromFile("../resources/blackPawn.png");
  sf::Texture blackRookTexture =
      loadTextureFromFile("../resources/blackRook.png");
  sf::Texture blackKnightTexture =
      loadTextureFromFile("../resources/blackKnight.png");
  sf::Texture blackBishopTexture =
      loadTextureFromFile("../resources/blackBishop.png");
  sf::Texture blackQueenTexture =
      loadTextureFromFile("../resources/blackQueen.png");
  sf::Texture blackKingTexture =
      loadTextureFromFile("../resources/blackKing.png");
};
