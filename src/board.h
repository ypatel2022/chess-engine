...
private:
    ...
    uint64_t removePiece(uint64_t piecePositions, sf::Vector2i boardPos, PieceColor color);
    ...
    uint64_t addPiece(uint64_t piecePositions, sf::Vector2i boardPos, PieceColor color);
